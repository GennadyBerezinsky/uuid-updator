...
## customer
cur = conn.cursor();
cur.execute("select c.customer_key, c.temp_customer_key_uuid from probirka_uuid.contact join probirka_uuid.customer c on c.customer_key = contact.customer_key")
res = cur.fetchall();
